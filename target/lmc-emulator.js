...
var _pbrinkmeier$lmc_emulator$Lmc_Tokenizer$tokenizeUsingRules = F3(
	function (rules, tokens, source) {
		...
		while (true) {
			...
			if (_p4 === '') {
				return _elm_lang$core$Result$Ok(
					_elm_lang$core$List$reverse(tokens));
			} else {
...
var _pbrinkmeier$lmc_emulator$Lmc_Tokenizer$toString = function (t) {
	var _p7 = t;
	switch (_p7.ctor) {
		case 'Mnemonic':
			return A2(
			...
			_0: A2(
				...
				function (_p8) {
					return _pbrinkmeier$lmc_emulator$Lmc_Tokenizer$NumberLiteral(
						_pbrinkmeier$lmc_emulator$Lmc_Tokenizer$ignorantToInt(_p8));
				}),
			_1: {
				ctor: '::',
				_0: A2(
...
var _pbrinkmeier$lmc_emulator$Lmc_Parser$Data = function (a) {
...
var _pbrinkmeier$lmc_emulator$Lmc_Parser$apply = F2(
	function (instType, tokens) {
		var _p1 = instType;
		if (_p1.ctor === 'NoArguments') {
			return _elm_lang$core$Result$Ok(
				{ctor: '_Tuple2', _0: _p1._0, _1: tokens});
		} else {
			var _p3 = _p1._0;
			var _p2 = tokens;
			_v2_2:
							...
							return _elm_lang$core$Result$Ok(
								{
									ctor: '_Tuple2',
									_0: _p3(
										_pbrinkmeier$lmc_emulator$Lmc_Parser$Labelled(_p2._0._0)),
									_1: _p2._1
								});
						case 'NumberLiteral':
							return _elm_lang$core$Result$Ok(
								{
									ctor: '_Tuple2',
									_0: _p3(
										_pbrinkmeier$lmc_emulator$Lmc_Parser$Immediate(_p2._0._0)),
									_1: _p2._1
								});
						default:
							break _v2_2;
			...
			return _elm_lang$core$Result$Err('Argument needed');
		}
	});
var _pbrinkmeier$lmc_emulator$Lmc_Parser$parseUsingRules = F3(
	function (rules, state, tokens) {
		...
		while (true) {
			...
			var instructions = _p4.instructions;
				...
				switch (_p5._0.ctor) {
					case 'Label':
						var newState = _elm_lang$core$Native_Utils.update(
							state,
							{
								labels: A3(_elm_lang$core$Dict$insert, _p5._0._0, position, labels)
							});
						var _v4 = rules,
							_v5 = newState,
							_v6 = _p5._1;
					...
					case 'Mnemonic':
						var _p8 = _p5._0._0;
						var _p6 = A2(_elm_lang$core$Dict$get, _p8, rules);
						if (_p6.ctor === 'Nothing') {
							return _elm_lang$core$Result$Err(
								A2(_elm_lang$core$Basics_ops['++'], 'Unknown instruction ', _p8));
						} else {
							var _p7 = A2(_pbrinkmeier$lmc_emulator$Lmc_Parser$apply, _p6._0, _p5._1);
							if (_p7.ctor === 'Err') {
								...
								var newState = _elm_lang$core$Native_Utils.update(
									state,
									{
										instructions: {ctor: '::', _0: _p7._0._0, _1: instructions},
										position: position + 1
									});
								var _v9 = rules,
									_v10 = newState,
					...
					default:
						return _elm_lang$core$Result$Err(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'Unexpected token ',
								_pbrinkmeier$lmc_emulator$Lmc_Tokenizer$toString(_p5._0)));
				}
			}
		}
	});
										...
										_1: {
											...
											_1: {
												...
												_0: {
													ctor: '_Tuple2',
													_0: 'DAT',
													_1: _pbrinkmeier$lmc_emulator$Lmc_Parser$OneArgument(_pbrinkmeier$lmc_emulator$Lmc_Parser$Data)
												},
												_1: {ctor: '[]'}
											}
										}
...
var _pbrinkmeier$lmc_emulator$Lmc_Parser$parse = function (_p9) {
	return A3(
		...
		A3(
			...
			{ctor: '[]'},
			0),
		A2(_elm_lang$core$List$filter, _pbrinkmeier$lmc_emulator$Lmc_Parser$isImportantToken, _p9));
};

var _pbrinkmeier$lmc_emulator$Lmc_Compiler$getBytecode = F2(
	function (labels, inst) {
		var _p0 = function () {
			var _p1 = inst;
			switch (_p1.ctor) {
				case 'Add':
					return {
						ctor: '_Tuple2',
						_0: 100,
						_1: _elm_lang$core$Maybe$Just(_p1._0)
					};
				case 'Subtract':
					return {
						ctor: '_Tuple2',
				...
				case 'Input':
					return {ctor: '_Tuple2', _0: 901, _1: _elm_lang$core$Maybe$Nothing};
				case 'Output':
					return {ctor: '_Tuple2', _0: 902, _1: _elm_lang$core$Maybe$Nothing};
				case 'CoffeeBreak':
					return {ctor: '_Tuple2', _0: 0, _1: _elm_lang$core$Maybe$Nothing};
				default:
					return {
						ctor: '_Tuple2',
						_0: 0,
		...
		var _p2 = arg;
		if (_p2.ctor === 'Nothing') {
			return _elm_lang$core$Result$Ok(base);
		} else {
			if (_p2._0.ctor === 'Immediate') {
				return _elm_lang$core$Result$Ok(base + _p2._0._0);
			} else {
				var _p4 = _p2._0._0;
				var _p3 = A2(_elm_lang$core$Dict$get, _p4, labels);
				if (_p3.ctor === 'Nothing') {
					return _elm_lang$core$Result$Err(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'label ',
							A2(_elm_lang$core$Basics_ops['++'], _p4, ' does not exist')));
				} else {
					return _elm_lang$core$Result$Ok(base + _p3._0);
				}
			}
		}
	});
var _pbrinkmeier$lmc_emulator$Lmc_Compiler$generateMemory = function () {
	var recurse = F3(
		function (pos, mem, codes) {
			recurse:
			while (true) {
				var _p5 = codes;
				if (_p5.ctor === '[]') {
					return _elm_lang$core$Result$Ok(mem);
				} else {
					var _v4 = pos + 1,
						_v5 = A3(_pbrinkmeier$lmc_emulator$Memory$insert, pos, _p5._0, mem),
						_v6 = _p5._1;
					pos = _v4;
					mem = _v5;
					codes = _v6;
	...
	return A2(recurse, 0, _pbrinkmeier$lmc_emulator$Memory$empty);
}();
var _pbrinkmeier$lmc_emulator$Lmc_Compiler$mapToBytecode = function () {
	var recurse = F2(
		function (results, state) {
			recurse:
			while (true) {
				var _p6 = state.instructions;
				if (_p6.ctor === '[]') {
					return _elm_lang$core$Result$Ok(
						_elm_lang$core$List$reverse(results));
				} else {
					var _p7 = A2(_pbrinkmeier$lmc_emulator$Lmc_Compiler$getBytecode, state.labels, _p6._0);
					if (_p7.ctor === 'Err') {
						return _elm_lang$core$Result$Err(_p7._0);
					} else {
						var _v9 = {ctor: '::', _0: _p7._0, _1: results},
...
var _pbrinkmeier$lmc_emulator$Lmc_Compiler$compile = function (_p8) {
	return A2(
		_elm_lang$core$Result$andThen,
		_pbrinkmeier$lmc_emulator$Lmc_Compiler$generateMemory,
...
var _pbrinkmeier$lmc_emulator$Update$Tick = function (a) {
...
var _pbrinkmeier$lmc_emulator$Subs$subscriptions = function (model) {
	return model.vmIsRunning ? A2(_elm_lang$core$Time$every, 100 * _elm_lang$core$Time$millisecond, _pbrinkmeier$lmc_emulator$Update$Tick) : _elm_lang$core$Platform_Sub$none;
};
			...
			switch (_p2.ctor) {
				...
				case 'Stack':
					return A2(
						_elm_lang$core$String$join,
						', ',
						A2(_elm_lang$core$List$map, _elm_lang$core$Basics$toString, _p2._0));
				default:
					return _p2._0 ? '1' : '0';
			}
		}();
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(registerValue),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _pbrinkmeier$lmc_emulator$View_Util$sectionView = F2(
	function (title, children) {
		var header = A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('lmc-section-title'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('lmc-section'),
				_1: {ctor: '[]'}
			},
			{ctor: '::', _0: header, _1: children});
	});
...
var _pbrinkmeier$lmc_emulator$View_Util$Wide = function (a) {
	return {ctor: 'Wide', _0: a};
};
var _pbrinkmeier$lmc_emulator$View_Util$Normal = function (a) {
	return {ctor: 'Normal', _0: a};
};
var _pbrinkmeier$lmc_emulator$View_Util$Flag = function (a) {
	return {ctor: 'Flag', _0: a};
};
var _pbrinkmeier$lmc_emulator$View_Util$Stack = function (a) {
	return {ctor: 'Stack', _0: a};
};
var _pbrinkmeier$lmc_emulator$View_Util$Numerical = function (a) {
...
var _pbrinkmeier$lmc_emulator$View$view = function (model) {
	var runControlView = function () {
		...
		if (_p0.ctor === 'Just') {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('lmc-error'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('lmc-ctrl'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
	...
	return A2(
		...
		},
		{
			ctor: '::',
			_0: A2(
				_pbrinkmeier$lmc_emulator$View_Util$topbarView,
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _pbrinkmeier$lmc_emulator$View_Util$columnsView(
							{
								ctor: '::',
								_0: _pbrinkmeier$lmc_emulator$View_Util$Normal(
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$button,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_pbrinkmeier$lmc_emulator$Update$Assemble),
															_1: {ctor: '[]'}
														}
													},
													{
										...
										_1: {
											ctor: '::',
											_0: A2(
												_pbrinkmeier$lmc_emulator$View_Util$sectionView,
												'Code',
												{
													ctor: '::',
													_0: A2(
								...
								_1: {
									ctor: '::',
									_0: _pbrinkmeier$lmc_emulator$View_Util$Wide(
										{
											ctor: '::',
											_0: runControlView,
											_1: {
															...
															_0: _pbrinkmeier$lmc_emulator$View_Util$Normal(
																{
																	...
																	_1: {
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _pbrinkmeier$lmc_emulator$View_Util$registersView(
																					{
																						ctor: '::',
																						_0: {
																							ctor: '_Tuple2',
																									...
																									_1: {
																										...
																										_0: {
																											...
																											_1: _pbrinkmeier$lmc_emulator$View_Util$Stack(
																												_elm_lang$core$List$reverse(model.vm.outbox))
																										},
																										_1: {ctor: '[]'}
																									}
																								}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _pbrinkmeier$lmc_emulator$Main$main !== 'undefined') {
    _pbrinkmeier$lmc_emulator$Main$main(Elm['Main'], 'Main', undefined);
}
